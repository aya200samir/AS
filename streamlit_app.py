...
.stTabs [data-baseweb="tab-list"]{gap:.4rem;overflow-x:auto}.stTabs [data-baseweb="tab"]{background:var(--as-panel);border:1px solid var(--as-line);border-radius:12px;color:var(--as-muted);padding:.65rem 1rem}.stTabs [aria-selected="true"]{color:var(--as-bg)!important;border-color:var(--as-text)!important;background:var(--as-text)!important}
.stButton>button,.stDownloadButton>button{border-radius:12px!important;border:1px solid var(--as-line)!important;background:var(--as-panel)!important;color:var(--as-text)!important;transition:.22s ease}.stButton>button:hover,.stDownloadButton>button:hover{transform:translateY(-2px);border-color:var(--as-text)!important}.stButton>button[kind="primary"],[data-testid="stBaseButton-primary"],[data-testid="stFormSubmitButton"] button{background:var(--as-text)!important;color:var(--as-bg)!important;border-color:var(--as-text)!important}
...
@media(max-width:760px){.as-hero{grid-template-columns:1fr}.as-visual{max-height:185px}}@media(prefers-reduced-motion:reduce){*{animation:none!important;transition:none!important}}
</style>
"""
